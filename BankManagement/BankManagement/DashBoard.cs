...
namespace BankManagement
{
    public partial class DashBoard : Form
    {
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if (currentButton != (Button)btnSender)
                {
                    ...
                    currentButton.Font = new System.Drawing.Font("Verdana", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void DisableButton()
        {
            foreach (Control previousBtn in panelMenu.Controls)
            {
                if (previousBtn.GetType() == typeof(Button))
                {
                    ...
                    previousBtn.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                }
            }
        }
        ...
        private void LoadCurrentUser()
        {
            ...
            txtCurrentUser.Text = EmpUserName;
            con.Close();
        }
        ...
        {
            OpenChildForm(new Forms.Account_types(), sender);
        }
